...
class MCCBFEvaluator:
    ...
    def save_results(self, output_dir='model', top_n=5):
        ...
        detail_path = os.path.join(output_dir, 'evaluasi_detail.csv')
        ...
        summary_path = os.path.join(output_dir, 'evaluasi_summary.csv')
        summary.to_csv(summary_path, index=False)
        
        print(f"✅ Hasil evaluasi berhasil disimpan:")
        print(f"   • {detail_path}")
